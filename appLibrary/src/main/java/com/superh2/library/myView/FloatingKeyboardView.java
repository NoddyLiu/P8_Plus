...
public class FloatingKeyboardView extends KeyboardView {
    ...
    private void drawHandle() {
        ...
        mHandlePath.lineTo(0, topPaddingPx - 15);
        mHandlePath.lineTo(width / 3, topPaddingPx - 15);
        mHandlePath.lineTo(width / 3, 0);
        mHandlePath.lineTo(2 * width / 3, 0);
        mHandlePath.lineTo(2 * width / 3, topPaddingPx - 15);
        mHandlePath.lineTo(width, topPaddingPx - 15);
